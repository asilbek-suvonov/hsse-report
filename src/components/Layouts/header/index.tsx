...
export function Header() {
  ...
  return (
    <header className="border-stroke shadow-1 dark:border-stroke-dark dark:bg-gray-dark sticky top-0  flex items-center justify-between border-b bg-white px-4 py-3 md:px-5 2xl:px-10">
      <button
